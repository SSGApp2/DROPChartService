$(function () {
    ...
    var labelPerformance1=["January", "February", "March", "April", "May", "June", "July"];
    var labelPerformance2=[ "กรุงเทพและปริมณฑล", "ภาคกลาง", "ภาคเหนือ", "ภาคใต้", "ภาคตะวันออก", "ภาคตะออกเฉียงเหนือ", "ภาคตะวันตก",];
//data pie chart
    var dataPerformance1= [120, 50, 100, 40,30,70,20];
    var dataPerformance2= [12, 50, 10, 40,3,70,20];
    var dataPerformance3= [10, 5, 10, 40,30,70,20];
    var titlePerformance1=["รายได้แยกตามภาค"];
    var titlePerformance2=["จำนวนสินค้าแยกตามภาค"];
    var titlePerformance3=["จำนวนน้ำหนักแยกตามภาค"];
